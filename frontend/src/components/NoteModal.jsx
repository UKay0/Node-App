  ...
  return (
    <div className='fixed inset-0 bg-gray-800 bg-opacity-75 flex justify-center items-center'>
      <div className='bg-white p-8 rounded'>
        ...
        <textarea value={description} onChange={(e)=> setDescription(e.target.value)} placeholder='Note Description' className='border p-2 w-full mb-4'></textarea>

        <button type='submit' className='bg-blue-500 text-white px-4 py-3 rounded'>{currentNote ? "Update Note" : "Add Note"}</button>
        </form>
